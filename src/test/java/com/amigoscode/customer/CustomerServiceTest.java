...
class CustomerServiceTest {
    ...
    private final CustomerDTOMapper customerDTOMapper2 = new CustomerDTOMapper();
    ...
    @BeforeEach
    void setUp() {
        underTest = new CustomerService(customerDao, customerDTOMapper, passwordEncoder, s3Service, buckets);
    }
